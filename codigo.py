...
def download(
    urls: list[str] = ["https://codigofacilito.com/articulos/restablecer_password_root_mysql", "1234", "https://codigofacilito.com/videos/realizar-conexion-con-el-servidor", "5676", "https://codigofacilito.com/videos/declarar-variables"],
    quality: Quality = Quality.BEST.value,
    headless: bool = False,
    

):
    """Descarga videos con autenticación usando cookies."""
